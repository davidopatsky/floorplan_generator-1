...
# Funkce na vykreslení obdélníku a anotací
...
# Vykreslení aktuálního výkresu do canvasu
...
if canvas_result.json_data is not None:
    if len(canvas_result.json_data["objects"]) > 0:
        ...
        selected = najdi_nejblizsi_anotaci(anotace, klik_x, 700 - klik_y)  # invertujeme Y osu

# Pokud máme vybranou anotaci
if selected:
